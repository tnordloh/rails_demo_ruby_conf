...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { abstract: @talk.abstract, bio: @talk.bio, email: @talk.email, name: @talk.name, notes: @talk.notes, title: @talk.title, track_id: @talk.track_id }
